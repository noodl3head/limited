...
class BackendConfig:
    ...
    mappls_access_token: str = os.getenv("MAPPLS_ACCESS_TOKEN", "")
    mappls_route_profile: str = os.getenv("MAPPLS_ROUTE_PROFILE", "biking")
    mappls_route_resource: str = os.getenv("MAPPLS_ROUTE_RESOURCE", "route_adv")
